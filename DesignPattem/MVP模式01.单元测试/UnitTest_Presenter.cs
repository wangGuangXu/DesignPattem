...
namespace MVP模式01.单元测试
{
    [TestClass]
    public class UnitTest_Presenter
    {
        ...
        public UnitTest_Presenter()
        {
            //mockCustomerView = Mock.Of<ICustomerView>(view =>view.CustomerList == new List<string>());
            //mockCustomerRepository = Mock.Of<ICustomerRepository>(repository => repository.GetAllCustomers() == stubCustomerList);
        ...
        public void Presenter_constructor_ShouldFillViewCustomerList()
        {
            ...
            //Assert.Equal<IList<string>>(mockCustomerView.Customers, customerNames.ToList());
        }
